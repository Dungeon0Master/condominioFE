...
const MainLayout = ({ usuario }) => {
    ...
    // Detectar ruta activa para poner el icono blanco o transparente
    const isActive = (path) => location.pathname === path;

    return (
        <div className="flex w-full h-screen bg-white overflow-hidden">
            
            <aside className="w-24 bg-brand-orange flex flex-col items-center py-6 z-50 shrink-0">
                ...
                <div className="mb-10 flex flex-col items-center">
                    ...
                    <span className="text-white text-[10px] font-bold tracking-wide text-center leading-tight">
                        Our<br/>Comunity
                    </span>
                </div>
                ...
                <nav className="flex-1 flex flex-col gap-8 w-full items-center">
                    ...
                    <button className="mt-4 text-white/80 hover:text-white">
                        <IconBell />
                    </button>
                </nav>
                ...
                <div className="mt-auto flex flex-col items-center gap-2">
                    <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-white bg-gray-200">
                        <img 
                            src={`https://ui-avatars.com/api/?name=${usuario?.name || 'User'}&background=random`} 
                            alt="User" 
